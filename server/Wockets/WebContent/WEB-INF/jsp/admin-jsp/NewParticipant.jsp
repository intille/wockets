...
<form:option value="">--Select--</form:option>
<form:option value="-5">Alabama UTC-05</form:option>
<form:option value="-9">Alaska UTC-09</form:option>
<form:option value="-11">American Samoa UTC-11</form:option>
<form:option value="-7">Arizona UTC-07</form:option>
<form:option value="-6">Arkansas UTC-06</form:option>
<form:option value="-8">California UTC-08</form:option>
<form:option value="-7">Colorado UTC-07</form:option>
<form:option value="-5">Connecticut UTC-05</form:option>
<form:option value="-5">Delware UTC-05</form:option>
<form:option value="-5">Florida UTC-05</form:option>
<form:option value="-5">Georgia UTC-05</form:option>
<form:option value="10">Guam UTC+10</form:option>
<form:option value="-10">Hawaii UTC-10</form:option>
<form:option value="-7">Idaho UTC-07</form:option>
<form:option value="-6">Illinois UTC-06</form:option>
<form:option value="-5">Indiana UTC-05</form:option>
<form:option value="-6">Iowa UTC-06</form:option>
<form:option value="-7">Kansas UTC-06</form:option>
<form:option value="-5">Kentucky UTC-05</form:option>
<form:option value="-6">Louisiana UTC-06</form:option>
<form:option value="-5">Main UTC-05</form:option>
<form:option value="-5">Maryland UTC-05</form:option>
<form:option value="-5">Massachusetts UTC-05</form:option>
<form:option value="-5">Michigan UTC-05</form:option>
<form:option value="-6">Minnesota UTC-06</form:option>
<form:option value="-6">Mississippi UTC-06</form:option>
<form:option value="-6">Missouri UTC-06</form:option>
<form:option value="-7">Montana UTC-07</form:option>
<form:option value="-6">Nebraska UTC-06</form:option>
<form:option value="-7">Nevada UTC-07</form:option>
<form:option value="-5">New Hampshire UTC-05</form:option>
<form:option value="-5">New Jersey UTC-05</form:option>
<form:option value="-7">New Mexico UTC-07</form:option>
<form:option value="-5">New York UTC-05</form:option>
<form:option value="-5">North Carolina UTC-05</form:option>
<form:option value="-6">North Dakota UTC-06</form:option>
<form:option value="10">North Mariana Islands UTC+10</form:option>
<form:option value="-5">Ohio UTC-5</form:option>
<form:option value="-6">Oklahoma UTC-06</form:option>
<form:option value="-7">Oregon UTC-07</form:option>
<form:option value="-5">Pennsylvania UTC-05</form:option>
<form:option value="-4">Puerto Rico UTC-04</form:option>
<form:option value="-5">Rhode Island UTC-05</form:option>
<form:option value="-5">South Carolina UTC-05</form:option>
<form:option value="-6">South Dakota UTC-06</form:option>
<form:option value="-5">Tennessee UTC-05</form:option>
<form:option value="-6">Texas UTC-06</form:option>
<form:option value="-7">Utah UTC-07</form:option>
<form:option value="-5">Vermont UTC-05</form:option>
<form:option value="-5">Virginia UTC-05</form:option>
<form:option value="-4">U.S. Virgin Islands UTC-04</form:option>
<form:option value="-8">Washington UTC-08</form:option>
<form:option value="-5">Washington, D.C. UTC-05</form:option>
<form:option value="-5">West Virginia UTC-05</form:option>
<form:option value="-6">Wisconsin UTC-06</form:option>
<form:option value="-7">Wyoming UTC-07</form:option>
</form:select>
</td>
</tr>
<tr>
