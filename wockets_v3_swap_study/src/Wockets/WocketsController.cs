...
namespace Wockets
{
    ...
    public sealed class WocketsController : XMLSerializable
    {
        ...
        //sets the default memory mode and transmission mode
        ...
        public void Initialize()
        {
            ...
            //Fahd: Check this varialbe with Fahd
            classifying = true;
        ...
        void InterfaceActivityTracker()
        {
            ...
            #region Initialize log directories
        ...
        #region Terminate Wockets Event (commented)
        ...
        #endregion Event access variables
        ...
        #region Classifier Instances (commented) 
        ...
        #region Train-Classify Functions (commented)

        #region Train function (commented)
        //private void Train()
        //{
        ...
        #region Classyfy function (commented)
        ...
        #endregion Train-Classify Functions


        #region Poll Data

        #region Lock (commented)
        ...
        private void Poll()
        {
            ...
            if ((this._Mode == MemoryMode.BluetoothToLocal) || (this._Mode == MemoryMode.BluetoothToShared))
            {
                ...
                #region MemoryMode BluetoothToLocal || BluetoothToShared
                ...
                #endregion MemoryMode BluetoothToLocal || BluetoothToShared
            ...
            else if (this._Mode == MemoryMode.SharedToLocal)
            {
                ...
                #region MemoryMode SharedToLocal
                ...
                #endregion MemoryMode SharedToLocal
