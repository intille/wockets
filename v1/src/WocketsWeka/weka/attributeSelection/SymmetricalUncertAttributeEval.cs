...
namespace weka.attributeSelection
{
	...
	/// <summary> Class for Evaluating attributes individually by measuring symmetrical 
	...
	/// </version>
	[Serializable]
	public class SymmetricalUncertAttributeEval:AttributeEvaluator, OptionHandler
	{
		...
		/// <summary> Initializes a symmetrical uncertainty attribute evaluator. 
		...
		/// <summary> set options to default values</summary>
		...
		/// <summary> evaluates an individual attribute by measuring the symmetrical
		...
		/// 
		/// </summary>
		/// <param name="argv">should contain the following arguments:
		/// -t training file
		/// </param>
		...
		public static void  Main(System.String[] argv)
		{
			try
			{
				System.Console.Out.WriteLine(AttributeSelection.SelectAttributes(new SymmetricalUncertAttributeEval(), argv));
			}
			catch (System.Exception e)
			{
				//e.WriteStackTrace(e, Console.Error);
