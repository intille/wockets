...
namespace weka.attributeSelection
{
	...
	/// <summary> Abstract attribute evaluator. Evaluate attributes individually.
	/// 
	/// </summary>
	...
	/// </version>
	[Serializable]
	public abstract class AttributeEvaluator:ASEvaluation
	{
		// ===============
		// Public methods.
		// ===============
		
		/// <summary> evaluates an individual attribute
		/// 
		/// </summary>
		/// <param name="attribute">the index of the attribute to be evaluated
		/// </param>
		/// <returns> the "merit" of the attribute
		/// </returns>
