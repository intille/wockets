 ...
 * @author Aida
 */
public class MeasureZRange extends javax.swing.JPanel {
    ...
    public MeasureZRange(JPanel upc, InputStream is, OutputStream os, CalibrationValues cv) throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Shake Wocket as hard as you can in the shown direction");
    ...
    private void startButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startButtonActionPerformed
        ...
        messageLabel1.setText("Measuring rage of Z Axis...");
    ...
    public Runnable testAxisRunnable = new Runnable() {
            public void run() { 
                try {  
                    int[] max_min = PcClient.measure_range('z', outStream, inStream);
                    calibrationValues.getAxisCalibration()[2].setMax(max_min[0]);
                    calibrationValues.getAxisCalibration()[2].setMin(max_min[1]);
                    PcClient.beepRunnable.run();
                    JPanel calibrateResultPanel = new MeasureAxesResult(userProcessContainer, inStream, outStream, calibrationValues);
                    userProcessContainer.add("calibrateResultPanel",calibrateResultPanel);
                    CardLayout c1 = (CardLayout)userProcessContainer.getLayout();
                    c1.next(userProcessContainer);
                } catch (IOException ex) {
                    System.out.println("test z range axis runnable error" + ex);
                } 
            }            
     };
