...
{
    public partial class ActivityTrackerForm : Form, SetTextControlCallback
    {
        ...
        public ActivityTrackerForm(string storageDirectory, WocketsController wocketsController, Session annotatedSession, DTConfiguration classifierConfiguration, int mode)
        {
            if (mode == 1)
