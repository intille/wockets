...
namespace InTheHand.Net.Sockets
{
	...
	public enum IrDAHints
	{
        ...
        /// </summary>
#if CODE_ANALYSIS
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1706:ShortAcronymsShouldBeUppercase", MessageId = "Member", Justification = "Copied from NETCF's equivalent.")]
#endif
        PnP = 1,
		/// <summary>
