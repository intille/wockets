...
namespace Winterdom.IO.FileMap
{
   ...
   public class MemoryMappedFile : MarshalByRefObject, IDisposable
   {
                           ...
                           long maxSize, String name ) 
      {
         ...
         if ( fileName != null )
         {
            ...
            if (hFile == INVALID_HANDLE_VALUE)
                throw Marshal.GetExceptionForHR(Marshal.GetLastWin32Error());//new FileMapIOException(Marshal.GetLastWin32Error());//Marshal.GetHRForLastWin32Error() );
      ...
      public static MemoryMappedFile Open ( MapAccess access, String name )
      {
         ...
         if (map._hMap == NULL_HANDLE)
             throw Marshal.GetExceptionForHR(Marshal.GetLastWin32Error());//new FileMapIOException ( Marshal.GetHRForLastWin32Error() );
