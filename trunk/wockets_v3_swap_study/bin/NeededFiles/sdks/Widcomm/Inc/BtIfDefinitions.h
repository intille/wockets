...
/////////////////////////////////////////////////////////////////////////////////////////
//  Definitions for HCI APIs
//
//  These HCI definitions added in SDK 1.5.0, BTW-CE support in 1.5.0.1900

// Define return code for HCI functions
//
typedef enum
{
    HCI_RETURN_SUCCESS,
    HCI_UNKNOWN_ADDR,               // Unknown remote BD address
    HCI_NO_RESOURCES,               // Insufficient resources to perform request
    HCI_WRONG_MODE,                 // Device is in wrong mode for request
    HCI_MODE_UNSUPPORTED,           // Request for 1 or more unsupported modes
    HCI_UNKNOWN_ERROR = 0xffff
} HCI_RETURN_CODE;

#define HCI_SUCCESS                     0x00

// HCI Link Policy settings flags 
...
// BEGIN:  added SDK 1.7, BTW-CE 1.7.0.1200
...
// END:  added SDK 1.7, BTW-CE 1.7.0.1200
...
#define L2CAP_CONN_LOCAL_POWEROFF    0xFFFE          // added SDK 1.5.0, BTW-CE 1.5.0
...
// END:  added SDK 1.7, BTW-CE 1.7.0.1200
#endif //ifndef BTM_API_H



#pragma pack ()

#endif // !defined_BTIFDEFINITIONS_H 
