...
namespace OpenNETCF.GDIPlus
{
    public class RegionPlus
    {
        ...
        public RegionPlus(GpRectF rect)
        {
            GpRegion region = new GpRegion();
        ...
        public RegionPlus(GraphicsPath path)
        {
            GpRegion region = new GpRegion();
        ...
        public RegionPlus(byte[] regionData)
        {
            GpRegion region = new GpRegion();
        ...
        public RegionPlus FromHRGN(HRGN hRgn)
        {
            GpRegion region = new GpRegion();
