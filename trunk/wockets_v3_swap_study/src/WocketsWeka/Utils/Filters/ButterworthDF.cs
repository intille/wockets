...
*/
    ...
    */
        ...
        public double[] dcof_bwbp(int n, double f1f, double f2f)
        {
...
*/
        ...
        public double sf_bwbp(int n, double f1f, double f2f)
        {
            int k;            // loop variables
