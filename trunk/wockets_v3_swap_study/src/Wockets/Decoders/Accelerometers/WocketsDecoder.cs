    ...
    public sealed class WocketsDecoder : Decoder
    {
        ...
        public override int Decode(int sourceSensor, CircularBuffer data, int start, int end)
        {
            ...
            while (rawDataIndex != end)
            {
                ...
                #region Determine the packet type
                ...
                #region If full packet was received, extract data
                ...
                if ((this.packetPosition == bytesToRead)) //a full packet was received
                {
                    ...
                    if ((packetType == SensorDataType.UNCOMPRESSED_DATA_PDU) || (packetType == SensorDataType.COMPRESSED_DATA_PDU))
                    {
                        ...
                        #region if packet is a data pdu, extract acceleration data
                        ...
                        #endregion if packet is a data pdu, extract acceleration data
                    ...
                    else if (packetType == SensorDataType.RESPONSE_PDU)
                    {
                        ...
                        #region If the packet is a command pdu response, decode it
                        ...
                        #endregion If command packet is a pdu response, decode it
                ...
                #endregion If the packet is a command pdu response, decode it
        ...
        public override int Decode(int sourceSensor, byte[] data, int length)
        {
            ...
            if (length != 0) // Have some data
            {
                while (rawDataIndex < length)
                {
                    ...
                    #region If full data packet received: extract acceleration data
                    ...
                    #endregion If full data packet received: extract acceleration data
