...
namespace Bornander.UI.BornanderProgressBar
{
    public class BornanderProgressBar : Panel
    {
...
#if PocketPC // See method BornanderProgressBar.DrawImage for reason for this #if.
        ...
        private void InitializeComponent()
        {
            this.SuspendLayout();
            // 
            // BornanderProgressBar
            // 
            this.Resize += new System.EventHandler(this.BornanderProgressBar_Resize);
        ...
        private void BornanderProgressBar_Resize(object sender, EventArgs e)
        {
            //
            // If the BornanderProgressBar is resized we dump out current offscreen and set it to null, a new one
            // will then be created as the OnPaint method will request this if it is null.
            //
            BornanderProgressBar.DisposeToNull(offscreenImage);
            BornanderProgressBar.DisposeToNull(offscreen);
        ...
        {
            BornanderProgressBar.DisposeToNull(backgroundCacheImage);
            BornanderProgressBar.DisposeToNull(overlayCacheImage);
            ...
            {
                // Render the background, here we pass the entire width of the BornanderProgressBar as the distance value because we
        ...
        protected static void DrawImage(Graphics graphics, Image image, Rectangle destinationRectangle, Rectangle sourceRectangle)
        {
             ...
             * BornanderProgressBar code does not draw using Graphics.DrawImage directly. It instead uses this 
        ...
        protected void Render(Graphics graphics, Image sourceImage, DrawMethod drawMethod, int leadingSize, int trailingSize, int distance)
        {
            ...
            // 
            BornanderProgressBar.DrawImage(
                graphics,
                sourceImage,
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // a resize of the BornanderProgressBar sets offscreenImage to null and this will then automatically 
            ...
            BornanderProgressBar.DrawImage(offscreen, backgroundCacheImage, ClientRectangle, ClientRectangle);
            ...
            BornanderProgressBar.DrawImage(offscreen, overlayCacheImage, ClientRectangle, ClientRectangle);
