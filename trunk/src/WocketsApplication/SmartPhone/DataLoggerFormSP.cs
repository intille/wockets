...
{
    public partial class DataLoggerFormSP : Form, SetTextControlCallback
    {
        ...
        public DataLoggerFormSP(string storageDirectory, WocketsController wocketsController, Session annotatedSession, DTConfiguration classifierConfiguration, int mode)
        {
        ...
        private void OnResize(object sender, EventArgs ee)
        {
            ...
            if ((this.Width > Constants.FORM_MIN_WIDTH) && (this.Height > Constants.FORM_MIN_HEIGHT))
            {
                ...
                textFont = new Font(Constants.FONT_FAMILY, 9F, System.Drawing.FontStyle.Regular);
                ...
                Font buttonFont = new Font(Constants.FONT_FAMILY, 9F, System.Drawing.FontStyle.Regular);
