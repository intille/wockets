...
namespace WocketsApplication.Utils.Forms.FileBrowser
{
	...
	internal class FileBrowserForm : Form
	{
        ...
        public FileBrowserForm()
		{
			...
			ilIcons.Images.Add(FileBrowserImages.Folder);
#if (PocketPC)
            ilIcons.Images.Add(FileBrowserImages.Device);
#else
            ilIcons.Images.Add(FileBrowserImages.PC);
#endif
            ilIcons.Images.Add(FileBrowserImages.Card);
