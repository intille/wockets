 ...
 * @author Aida
 */
public class MeasureXRange extends javax.swing.JPanel {
    ...
    public MeasureXRange(JPanel upc, InputStream is, OutputStream os, CalibrationValues cv) throws IOException {
        initComponents();
    ...
    private void startButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startButtonActionPerformed
        ...
        messageLabel1.setText("Measuring rage of X Axis...");
    ...
    public Runnable testAxisRunnable = new Runnable() {
            public void run() { 
                try {  
                    int[] max_min = PcClient.measure_range('x', outStream, inStream);
                    calibrationValues.getAxisCalibration()[0].setMax(max_min[0]);
                    calibrationValues.getAxisCalibration()[0].setMin(max_min[1]);
                    PcClient.beepRunnable.run();
                    JPanel calibrateYRangePanel = new MeasureYRange(userProcessContainer, inStream, outStream, calibrationValues);
                    userProcessContainer.add("calibrateYRangePanel",calibrateYRangePanel);
                    CardLayout c1 = (CardLayout)userProcessContainer.getLayout();
                    c1.next(userProcessContainer);
                } catch (IOException ex) {
                    System.out.println("test x range axis runnable error" + ex);
                } 
            }            
     };
