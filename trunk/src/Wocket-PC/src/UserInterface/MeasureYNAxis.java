 ...
 * @author Aida
 */
public class MeasureYNAxis extends javax.swing.JPanel {
    ...
    public MeasureYNAxis(JPanel upc, InputStream is, OutputStream os, CalibrationValues cv) throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Negative Y axis");
    ...
    private void didItButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_didItButtonActionPerformed
        ...
        messageLabel1.setText("Measuring Negative Y Axis...");
    ...
    public Runnable testAxisRunnable = new Runnable() {
            public void run() { 
                try {                     
                    int mid_value = PcClient.test_Axes('y', outStream, inStream);
                    calibrationValues.getAxisCalibration()[1].setNegativeMid(mid_value);
                    PcClient.beepRunnable.run();
                    JPanel calibrateZPanel = new MeasureZAxis(userProcessContainer, inStream, outStream, calibrationValues);            
                    userProcessContainer.add("calibrateZPanel",calibrateZPanel);
                    CardLayout c1 = (CardLayout)userProcessContainer.getLayout();
                    c1.next(userProcessContainer);
                } catch (IOException ex) {
                    System.out.println("test negative y axis runnable error" + ex);
                } 
            }            
     };
