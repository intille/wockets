 ...
 * @author Aida
 */
public class MeasureXNAxis extends javax.swing.JPanel {
    ...
    public MeasureXNAxis(JPanel upc, InputStream is, OutputStream os, CalibrationValues cv) throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Negative X axis");
    ...
    private void didItButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_didItButtonActionPerformed
        ...
        messageLabel1.setText("Measuring  Negative X Axis...");
    ...
    public Runnable testAxisRunnable = new Runnable() {
            public void run() { 
                try {                     
                    int mid_value = PcClient.test_Axes('x', outStream, inStream);
                    calibrationValues.getAxisCalibration()[0].setNegativeMid(mid_value);
                    PcClient.beepRunnable.run();
                    JPanel calibrateYPanel = new MeasureYAxis(userProcessContainer, inStream, outStream, calibrationValues);            
                    userProcessContainer.add("calibrateYPanel",calibrateYPanel);
                    CardLayout c1 = (CardLayout)userProcessContainer.getLayout();
                    c1.next(userProcessContainer);
                } catch (IOException ex) {
                    System.out.println("test negative x axis runnable error" + ex);
                } 
            }            
     };
