...
typedef enum {
    ...
    OMX_Sts_NullPtrErr                = -8,    /* Null pointer error */
    ...
    OMX_StsICJP_JPEGMarkerWarn       = -181,  /* JPEG marker encountered; Huffman decoding */
                                              /* operation terminated early.                         */
    OMX_StsIP_SizeErr                = -6,    /* One or more ROI size fields has negative or zero value */
    OMX_StsIP_StepErr                = -14,   /* Step value is less than or equal to zero */
    OMX_StsIPBM_MirrorFlipErr        = -21,   /* Invalid flip mode                   */
    OMX_StsIPBM_ScaleRangeErr        = -13,   /* Scale bounds are out of range */
    OMX_StsIPPP_AnchorErr            = -34,   /* Anchor point is outside the mask */
    OMX_StsIPPP_ChannelErr           = -47,   /* Illegal channel number  */
    OMX_StsIPPP_ContextMatchErr      = -17,   /* Context parameter doesn't match to the operation */

    OMX_StsSP_EvenMedianMaskSize     =  -180,    /* Even size of the Median Filter mask was replaced by the odd one */
