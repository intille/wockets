...
{
    /// <summary>
    /// A class to send and receive system-wide named events for synchronizing or waking up applications
    /// </summary>
    public class NamedEvents
    {
        ...
        /// <summary>
        /// Blocking call to wait for an event
        /// </summary>
        /// <param name="name">Name of the event</param>
