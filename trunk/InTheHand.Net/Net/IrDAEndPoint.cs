...
namespace InTheHand.Net
{
    ...
    public class IrDAEndPoint : EndPoint
	{
        ...
        #region Serialize
        /// <summary>
		/// Serializes endpoint information into a <see cref="SocketAddress"/>.
		/// </summary>
		/// <returns></returns>
        ...
        #region Create
        /// <summary>
		/// Creates an <see cref="IrDAEndPoint"/> from a socket address
		/// </summary>
		/// <param name="socketAddress">A <see cref="SocketAddress"/>.</param>
		/// <returns></returns>
