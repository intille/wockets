...
namespace InTheHand.Net.Sockets
{
	...
	public class BluetoothListener
	{
        ...
        private BluetoothClient.SocketOptionHelper m_optionHelper;
        ...
        /// <summary>
		///  Gets the underlying <see cref="BluetoothEndPoint"/> of the current <see cref="BluetoothListener"/>.  
		/// </summary>
		...
		/// <remarks><see cref="BluetoothListener"/> creates a <see cref="Socket"/> to listen for incoming client connection requests.
        ...
        public void Start(int backlog)
		{
            ...
            if (!active)
            {
                ...
                serviceHandle = SetService(rawRecord, codService);
		...
		private static IntPtr SetService(byte[] sdpRecord, ServiceClass cod)
		{
			BTHNS_SETBLOB blob = new BTHNS_SETBLOB(sdpRecord);
        ...
        {
            SetPin(((BluetoothEndPoint)serverSocket.RemoteEndPoint).Address, pin);
        }
