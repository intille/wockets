...
namespace InTheHand.Net.Bluetooth
{
    ...
    public class ServiceElement
    {
        ...
        object m_rawValue;
        //
        private const bool m_strictStringDecoding = true;
    ...
    */
                ...
                if (type == ElementType.Nil) {
                    ...
                    switch (type) {
                        case ElementType.UInt8:
                            validTypeForType = value.GetType() == typeof(Byte);
                            break;
                        case ElementType.Int8:
                            validTypeForType = value.GetType() == typeof(SByte);
                            break;
                        case ElementType.UInt16:
                            validTypeForType = value.GetType() == typeof(UInt16);
                            break;
                        case ElementType.Int16:
                            validTypeForType = value.GetType() == typeof(Int16);
                            break;
                        case ElementType.UInt32:
                            validTypeForType = value.GetType() == typeof(UInt32);
                            break;
                        case ElementType.Int32:
                            validTypeForType = value.GetType() == typeof(Int32);
                            break;
                        default:
                    ...
                    validTypeForType = value.GetType() == typeof(Guid);
                } else if (type == ElementType.TextString) {
                    validTypeForType = value.GetType() == typeof(byte[]) || value.GetType() == typeof(String);
                } else if (type == ElementType.Boolean) {
                    validTypeForType = value.GetType() == typeof(Boolean);
                    ...
                    validTypeForType = value.GetType() == typeof(byte[]) || value.GetType() == typeof(Uri);
                }
                if (!validTypeForType) {
        ...
        public static ServiceElement CreateNumericalServiceElement(ElementType elementType, object value)
        {
            ...
            if (!(etd == ElementTypeDescriptor.UnsignedInteger
                ...
                throw new ArgumentException(ErrorMsgCreateNumericalGivenNonNumber);
            }
        ...
        private static object ConvertNumericalValue(ElementType elementType, object value)
        {
            ...
            if (value is Byte || value is Int16 || value is Int32
                || value is SByte || value is UInt16 || value is UInt32) {
                try {
        ...
        public Uri GetValueAsUri()
        {
            ...
            if (asUri == null) {
                asUri = ServiceRecordParser.CreateUriFromBytes((byte[])m_rawValue);
            }
            return asUri;
        }
        ...
        /// <exclude/>
        public const String ErrorMsgCreateNumericalGivenNonNumber
            = "Not a numerical type.";
        /// <exclude/>
        public const string ErrorMsgListContainsNotElement
            = "The list contains a element which is not a ServiceElemen.";
