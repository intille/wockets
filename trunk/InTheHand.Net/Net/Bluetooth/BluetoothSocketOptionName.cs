...
{
    /// <summary>
    /// Defines <see cref="System.Net.Sockets.Socket"/> configuration option names for the <see cref="System.Net.Sockets.Socket"/> class.
    /// </summary>
#if V2
    public static class BluetoothSocketOptionName
    {
#else
    public sealed class BluetoothSocketOptionName
    {
        private BluetoothSocketOptionName() { }
#endif
        /// <summary>
