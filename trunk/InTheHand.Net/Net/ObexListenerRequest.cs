...
{
	/// <summary>
	/// Describes an incoming OBEX request to an <see cref="ObexListener"/> object.
	/// </summary>
	public class ObexListenerRequest
	{
		...
		/// <remarks>For a complete list of request headers, see the <see cref="ObexHeader"/> enumeration.</remarks>
