...
<div id="chartContainer"  style="position:absolute; top: 0px; left: 0px; z-index: 0;">FusionCharts will load here!</div>          
    <script type="text/javascript"><!--         

      var myChart = new FusionCharts( "ZoomLine.swf", 
      "myChartId", "800", "500", "0", "1" );
      myChart.setXMLUrl("Data.php?date=<?php echo $_GET['date'];?>&participant_id=<?php echo $_GET['participant_id'];?>");
