...
{
  	$theString = "&showRawData=" . $showRawData . "&showBytesSent=" . $showBytesSent . "&showBytesReceived=" . $showBytesReceived . "&showBattery=" . $showBattery . "&showPhoneStats=" . $showPhoneStats;
  	return $theString;
}
...
?>
        ...
        <option value="main.php?participant_id=<?php echo $row_Recordset1['id'] . GetURLParamString();?>" <?php if ((isset($_GET['participant_id'])) &&($_GET['participant_id']==$row_Recordset1['id'])) echo "selected=\"selected\""; ?>><?php echo $row_Recordset1['last_name'].", ". $row_Recordset1['first_name'];?></option>
        <?php
		} else {
			echo '';
		} // end if;
...
?>
  ...
  $url="main.php?participant_id=".$_GET['participant_id']. GetURLParamString() . "&";
...
?>
 		...
 		<form method="post" action="<?php echo $PHP_SELF;?>">
 		   	...
 		   	<br>
	        <font size = '2'>
	        <input name="viewBy" type="radio" id="placement" value="0">Placement
	        <input name="viewBy" type="radio" id="macAddress" value="1">MAC Address
			</font>
			<br>
    ...
    <iframe src ="Chart.php?date=<?php echo $_GET['date'];?>&participant_id=<?php echo $_GET['participant_id'] . GetURLParamString();?>" style="border-style:none;width: 820px; height: 520px;" frameborder="0" scrolling="no">
