...
namespace WocketsAppNS
{
    partial class DataLoggerForm
    {
        ...
        private void InitializeInterface()
        {
            ...
            this.SampLabels = new Label[CurrentWockets._Controller._Sensors.Count];
            ...
            int textBoxHeight = ((int)(0.35 * ((Panel)this.panels[VISUALIZE_PANEL]).ClientSize.Height) - ((CurrentWockets._Controller._Sensors.Count - 1) * Constants.WIDGET_SPACING)) / num_rows;
            ...
            for (int i=0;(i<CurrentWockets._Controller._Sensors.Count);i++)
            {
                ...
                if (CurrentWockets._Controller._Sensors[i]._Receiver._Type == ReceiverTypes.HTCDiamond)
                    t.Text = "Intrnl";
                else
                {
                    string address = ((Wockets.Receivers.RFCOMMReceiver)((Wockets.Sensors.Accelerometers.Wocket)(CurrentWockets._Controller._Sensors[i]))._Receiver)._Address;
                ...
                t.Name = "W" + CurrentWockets._Controller._Sensors[i]._ID;
                t.Size = new System.Drawing.Size(textBoxWidth, 32);
                t.Location = new System.Drawing.Point(currentTextX, currentTextY);
                t.Font = textFont;
                this.sensorLabels.Add("W" + CurrentWockets._Controller._Sensors[i]._ID, t);
                this.sensorStatus.Add("W" + CurrentWockets._Controller._Sensors[i]._ID, p);
                //this.sensorBattery.Add("W" + CurrentWockets._Controller._Sensors[i]._ID, p2);
